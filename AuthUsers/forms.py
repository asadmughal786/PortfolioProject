...
class SignUpForm(UserCreationForm):
    ...
    user_age = forms.IntegerField(validators=[validators.MaxValueValidator(100)])
    ...
    user_phone = PhoneNumberField(region="PK",widget=PhoneNumberPrefixWidget(country_choices=[("PK", "Pakistan")]))
    ...
    class Meta:
        model = CustomUser
        fields = ['profile_picture','username','email','first_name', 'last_name','password1','password2','user_age','user_phone','user_city','user_address','user_freelancer','user_bio','user_website']
